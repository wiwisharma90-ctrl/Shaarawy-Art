...
const translations = {
    ar: {
        ...
        valStyle5: "رسم جداري وتظليل واقعي بالأبيض والأسود", valTools5: "الوان زيتية ابيض اسود ،بخاخات ابيض اسود ،خلفيات الوان اكريليك ،فرنيكس او عازل", valLoc5: " عنابة ثانوية مثقن رشاشي احمد الحجار", valEvent5: "تصميم وتنسيق بصري تعليمي (2024)",
    ...
    en: {
        ...
        valStyle5: "Mural Painting & Realistic B&W Shading", valTools5: "Oil paints (black and white), spray paints (black and white), acrylic paint backgrounds, varnish or sealant", valLoc5: "Annaba, Ahmed El Hadjar High School", valEvent5: "Educational Visual Concept & Design (2024)",
